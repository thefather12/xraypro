    ...
    get clients() {
        switch (this.protocol) {
            case Protocols.VMESS:
                return this.settings.vmesses;
            case Protocols.VLESS:
                return this.settings.vlesses;
            case Protocols.TROJAN:
                return this.settings.trojans;
...
Inbound.Settings = class extends XrayCommonClass {
    ...
    static getSettings(protocol) {
        switch (protocol) {
            ...
            case Protocols.MIXED:
                return new Inbound.MixedSettings(protocol);
            case Protocols.HTTP:
    ...
    static fromJson(protocol, json) {
        switch (protocol) {
            ...
            case Protocols.TUNNEL:
                return Inbound.TunnelSettings.fromJson(json);
            case Protocols.MIXED:
                return Inbound.MixedSettings.fromJson(json);
            case Protocols.HTTP:
...
Inbound.VLESSSettings = class extends Inbound.Settings {
    ...
    static fromJson(json = {}) {
        ...
        const obj = new Inbound.VLESSSettings(
            ...
            json.decryption,
            json.encryption,
            Inbound.VLESSSettings.Fallback.fromJson(json.fallbacks || []), json.selectedAuth
        );
        return obj;
    }
